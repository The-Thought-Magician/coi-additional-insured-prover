    ...
    <div className="space-y-6">
          ...
          <TBody>
            {filtered.map((c) => (
              <TR key={c.id}>
                ...
                <TD className="font-mono text-xs text-slate-400">{c.naic || '—'}</TD>
                <TD>
                  {c.am_best_rating ? (
      ...
      >
        <div className="space-y-4">
          ...
          <div>
            <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-slate-500">Carrier Name *</label>
            <input
              value={form.name}
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-slate-500">NAIC #</label>
              <input
                value={form.naic}
            ...
            <div>
              <label className="mb-1 block text-xs font-medium uppercase tracking-wide text-slate-500">AM Best Rating</label>
              <select
