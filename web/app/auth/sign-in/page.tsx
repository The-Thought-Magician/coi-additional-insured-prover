    ...
    <main className="min-h-screen bg-slate-950 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link href="/" className="text-2xl font-black text-amber-400">CoiAdditionalInsuredProver</Link>
          <h1 className="text-2xl font-bold mt-4 text-white">Sign in to your account</h1>
          <p className="text-sm text-slate-500 mt-1">Prove every certificate transfers risk.</p>
        </div>
